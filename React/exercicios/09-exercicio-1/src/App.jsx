export default function App() {
  return(
    <div>
      ...
      <button ><a href="https://react.dev/learn" target="_blank">Aprenda React</a></button>
      <button><a href="https://react.dev/reference/react" target="_blank">Referência da API</a></button>
      <hr />
